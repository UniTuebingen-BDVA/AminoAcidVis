...
file(GLOB_RECURSE GLEW
    "${PROJECT_EXTERNALS_PATH}/GLEW/src/glew.c")
include_directories("${PROJECT_EXTERNALS_PATH}/GLEW/include")
...
add_subdirectory("${PROJECT_EXTERNALS_PATH}/GLFW")
...
add_definitions(-DDEFAULT_RESOURCES_PATH="${PROJECT_DEFAULT_RESOURCES_PATH}")
