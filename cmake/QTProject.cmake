# A cmake template for a c++ project using QT and glew(OpenGl).
...
include(${CMAKE_MODULE_PATH}/submodules/include_GLEW.cmake)
...
if (NOT XTC_FOUND)
    message(STATUS " ")
    message(STATUS "=======================================================================================================")
    message(STATUS "Project created only for XTC. Please build XTC and then rerun CMake to build the rest!")
    message(STATUS "=======================================================================================================")
    message(STATUS " ")
    return()
endif ()
...
IF (WIN32)
    find_path(QT_CMAKE_DIR Qt5/Qt5Config.cmake
            PATH_SUFFIXES cmake
            PATHS "D:/Qt/5.15.2/mingw81_64/lib" "C:/Qt/5.15.2/mingw81_64/lib" "E:/Qt/5.15.2/mingw81_64/lib"
...
set(ALL_LIBRARIES ${ALL_LIBRARIES} Qt5::Widgets Qt5::OpenGL Qt5::Qml Qt5::Quick Qt5::QuickWidgets ${GLEW_LIBRARY})
